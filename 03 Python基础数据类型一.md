...
![img](http://crm.pythonav.com/media/uploads/2018/11/21/1122844-20181010090224856-1876819854.PNG)
...
![img](http://crm.pythonav.com/media/uploads/2018/11/21/1122844-20181010091020572-1424006569_L6GTQJM.PNG)
...
![img](http://crm.pythonav.com/media/uploads/2018/11/22/1122844-20181010101914405-85268642%20(1).PNG)
...
![img](http://crm.pythonav.com/media/uploads/2018/11/22/1122844-20181010102021647-1593251896.PNG)
...
实现一个整数加法计算器(两个数相加)：
如：content ``=` `input``(``"请输入内容:"``) 用户输入：``5``+``9``或``5``+``9``或``5` `+` `9``，然后进行分割再进行计算。
实现一个整数加法计算器（多个数相加）：
