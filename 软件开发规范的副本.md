...
![image-20190813222212676](assets/image-20190813222212676.png)
...
```python
userinfo = "/Users/meet/PycharmProjects/blog/db/register"
```

2. **划分文件**

![image-20190814154654992](assets/image-20190814154654992.png)
...
![image-20190814155135069](assets/image-20190814155135069.png)

**src.py**:这个文件主要存放的就是核心逻辑功能，你看你需要进行选择的这些核心功能函数，都应该放在这个文件中。

![image-20190814155306414](assets/image-20190814155306414.png)
...
![image-20190814155532285](assets/image-20190814155532285.png)
...
![image-20190814155821859](assets/image-20190814155821859.png)
